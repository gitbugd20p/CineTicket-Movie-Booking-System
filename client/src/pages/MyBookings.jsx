...
const MyBookings = () => {
  ...
  return !isLoading ? (
    <div className="relative min-h-[80vh] pt-30 md:px-16 md:pt-40 lg:px-40">
          ...
          >
            ...
            <div className="flex flex-col justify-between p-4 md:items-end md:text-right">
              <div className="flex items-center gap-4">
                ...
                {!item.isPaid && (
                  <Link to={item.paymentLink} className="bg-primary mb-3 cursor-pointer rounded-full px-4 py-1.5 text-sm font-medium">
                    Pay Now
                  </Link>
                )}
              </div>
